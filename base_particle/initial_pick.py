#使用step2校正後，可能會有同個座標點多次重複的情況

#適用於使用預訓練模型選擇初始粒子，因此沒有前次座標點需要比對重複座標
import os
iter = input("iter?\n")
...
#partial_dir = "/home/m112040034/workspace/simulation/partial_box/"+iter  # 參考檔案路徑
...
def process_files(input_dir, output_dir):    
    ...
    for filename in files:
        ...
        #filtered_lines = filter_lines(grouped_lines)
        
        # 將處理後的結果寫入新的檔案中
        write_box_file(output_file_path, grouped_lines)
